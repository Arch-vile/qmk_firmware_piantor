...
const uint16_t PROGMEM umlaut_combo[] = {LGUI_T(KC_D), LSFT_T(KC_F), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x6_3(
        ...
        KC_NO,          KC_Z,               KC_X,               KC_C,               KC_V,               KC_B,                   /**/            KC_N,               KC_M,               KC_COMM,            KC_DOT,             KC_QUES,          KC_NO,
                                                                LT(WIN, KC_ESC),    LT(NUM, KC_SPC),    LT(NAV, KC_TAB),        /**/            KC_LSFT,            MO(SYM),            MO(MOUSE )
    ),
    ...
    [SYM] = LAYOUT_split_3x6_3(
        KC_NO,    KC_NO,      KC_PERC,    KC_QUOT,    KC_UNDS,    KC_HASH,   /**/     KC_AT,      KC_AMPR,    KC_DLR,     KC_CIRC,    KC_NO,      KC_NO,
    ...
    [WIN] = LAYOUT_split_3x6_3(
        KC_NO, KC_NO,           KC_NO,      KC_NO,            KC_NO,           SGUI(KC_5),              /**/   KC_TRNS,                   KC_NO,          KC_NO,          KC_NO,      KC_NO,  KC_NO,
        KC_NO, LGUI(KC_GRV),    KC_NO,      LGUI(KC_RCBR),    CMD_TAB,         LSFT(LGUI(LCTL(KC_4))),  /**/   LGUI(KC_PLUS),             LCAG(KC_DOWN),  LCAG(KC_UP),    KC_NO,      KC_NO,  KC_NO,
        KC_NO, KC_NO,           KC_NO,      LGUI(KC_LCBR),    LSFT_T(CMD_TAB), SGUI(KC_4),              /**/   LGUI(KC_MINS),             KC_NO,          KC_NO,          KC_NO,      KC_NO,  KC_NO,
    ...
    [NUM] = LAYOUT_split_3x6_3(
        ...
        KC_NO, LCTL_T(KC_NO),   LALT_T(KC_F4),  LGUI_T(KC_F5),  LSFT_T(KC_F6),  KC_F10,    /**/        KC_0,    LSFT_T(KC_4),   RGUI_T(KC_5),   RALT_T(KC_6),   RCTL_T(KC_NO),  KC_NO,
