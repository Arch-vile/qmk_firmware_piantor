...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x6_3(
        LALT(LGUI(KC_G)),          KC_Q,               KC_W,               KC_E,               KC_R,               KC_T,                   /**/            KC_Y,               KC_U,               KC_I,               KC_O,               KC_EXLM,          LCTL(KC_B),
    ...
    [MOUSE] = LAYOUT_split_3x6_3(
        ...
        KC_TRNS,    OSM(MOD_LCTL),      OSM(MOD_RALT),          OSM(MOD_LGUI),      OSM(MOD_LSFT),      KC_TRNS,           /**/     KC_TRNS,    OSM(MOD_LSFT),       OSM(MOD_LGUI),          OSM(MOD_RALT),          OSM(MOD_LCTL),      KC_TRNS,
        KC_TRNS,    KC_TRNS,            KC_TRNS,                KC_TRNS,            KC_TRNS,            KC_TRNS,           /**/     KC_TRNS,    KC_TRNS,             KC_TRNS,                KC_TRNS,                KC_TRNS,            KC_TRNS,
